...
function BurgerPhotoFieldInner({
  alt,
  imageUrl,
  isUploading,
  onImageFile,
...
function BurgerPhotoField(props: Readonly<Props>) {
  const resetKey = props.imageUrl ?? '';
  return <BurgerPhotoFieldInner key={resetKey} {...props} />;
}

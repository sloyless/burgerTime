...
const About: NextPage = () => {
  return (
    <Layout>
      ...
      />
      <main className="prose prose-stone prose-headings:font-serif prose-headings:font-bold prose-a:text-brand-700 prose-a:no-underline hover:prose-a:text-brand-800 mx-auto max-w-3xl py-8">

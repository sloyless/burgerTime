...
const Add: NextPage = () => {
  ...
  function updateScoreHandler() {
    const newBurger = {
      ...
      sauce,
      veg,
      venue: venueInputRef.toString(),
      address: locationInputRef.toString(),
      notes: notesInputRef.toString(),
      cookType: cookInputRef.toString(),
    };
    ...
    <Layout>
      ...
      <main className="p-4">
        <div className="container mx-auto">
          <h1 className="mb-5 text-3xl">Add a Burger</h1>
          <form onSubmit={submitHandler} className="my-5">
            ...
            <div className="flex items-end justify-between">
              <p className="mb-3 me-5 w-4/5 text-sm md:text-base">
                For the following fields, rate the quality of each category on a
                5-star scale. <em>(1 = lowest, 5 = highest)</em>
              </p>
            ...
            <FieldSet>
              <div className="md:flex md:w-1/2">
                ...
                <StarRating id="veg" rating={veg} updateRating={setVeg}>
                  ...
                  and anything else that might be used to dress up the burger in
                  question.
                </StarRating>
              </div>
              <div className="mt-3 md:mt-0 md:flex md:w-1/2">
            ...
            <FieldSet>
              <div className="md:flex md:w-1/2">
                ...
                <Input
                  ...
                  placeholder="Grill"
                >
                  How was the burger cooked? Griddle? Propane or Charcoal Grill?
                  Campfire?
                </Input>
              </div>
              <div className="mt-3 md:mt-0 md:flex md:w-1/2">
